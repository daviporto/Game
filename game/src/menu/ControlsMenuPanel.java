...
//	private final int x = ((280 * 3 + 240) / 2) - widthP / 2;// half of screen
	...
	public ControlsMenuPanel(MenuController menuController) {
		...
		fireAbility = buttonFactory(new Vector2i(DEFAULTSIZE.x + 100, 20 + DEFAULTSIZE.y * 1), DEFAULTSIZE, "fire Ability = 1");
		iceAbility = buttonFactory(new Vector2i(DEFAULTSIZE.x + 100, 20 + DEFAULTSIZE.y * 2), DEFAULTSIZE, "ice Ability = 2");
		poisonAbility = buttonFactory(new Vector2i(DEFAULTSIZE.x + 100, 20 + DEFAULTSIZE.y * 3), DEFAULTSIZE, "poison Ability = 3");

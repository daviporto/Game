...
public class UpgradeAbility {
	...
	public UpgradeAbility() {
		...
		try {
			fireUpgradeImage = ImageIO.read(UpgradeAbility.class.getResource("/textures/upgradeAbilities/upgradeFireAbility.png"));
			iceUpgradeImage = ImageIO.read(UpgradeAbility.class.getResource("/textures/upgradeAbilities/uogradeIceAbility.png"));
			poisonUpgradeImage = ImageIO.read(UpgradeAbility.class.getResource("/textures/upgradeAbilities/ugradePoisonAbility.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void removeButton(int button) {
		if(button == 0)  UPAbilitiesPanel.removeComponent(FireAbilityButton);
		if(button == 1)  UPAbilitiesPanel.removeComponent(iceAbilityButton);
		if(button == 2)  UPAbilitiesPanel.removeComponent(poisonAbilityButton);

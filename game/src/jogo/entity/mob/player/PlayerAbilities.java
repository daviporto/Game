...
public class PlayerAbilities {
	...
	private KindofProjectile currentAbility;

	public PlayerAbilities(UIManager ui, KindofProjectile currentAbility) {
	...
	public void drawHablities() {
		...
		UIButton iceABilityImageButton = new UIButton(new Vector2i(fireAbilityImage[0].getWidth() + 10, 0),
				iceAbilityImage[3], () -> currentAbility = KindofProjectile.ICEBOOL);
		...
		poisonABilityImageButton.setActinoListener(() -> currentAbility = KindofProjectile.POISONBOOL);
